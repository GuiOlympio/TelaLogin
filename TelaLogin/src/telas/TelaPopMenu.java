 ...
 * @author gingu
 */
public class TelaPopMenu extends javax.swing.JFrame {

    /**
     * Creates new form TelaPopMenu
     */
    public TelaPopMenu() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaPopMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaPopMenu().setVisible(true);
            }
        });
    }
